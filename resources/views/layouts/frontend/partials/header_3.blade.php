...
echo $top_nav_col_1; @endphp">
                    ...
                    <div class="{{ $top_nav_col_2 }}">
                        <ul class="navbar-nav justify-content-center">
                            @if (!empty(setting('facebook')))
                                <li class="nav-item">
                                    <a target="_blank" class="nav-link" href="{{ setting('facebook') }}"><i
                            ...
                            @if (!empty(setting('instagram')))
                                <li class="nav-item">
                                    <a target="_blank" class="nav-link"
                                        href="https://instagram.com/{{ setting('instagram') }}"><i
                                            class="fab fa-instagram"></i></a>
                                </li>
                            @endif
                            @if (!empty(setting('twitter')))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ setting('twitter') }}"><i
                                            class="fab fa-twitter"></i></a>
                                </li>
                            @endif
                            @if (!empty(setting('linkedin')))
                                <li class="nav-item">
                                    <a target="_blank" class="nav-link" href="{{ setting('linkedin') }}"><i
                                            class="fab fa-linkedin"></i></a>
                                </li>
                            @endif
                            @if (!empty(setting('youtube')))
                                <li class="nav-item">
                                    <a target="_blank" class="nav-link" href="{{ setting('youtube') }}"><i
                            ...
                            @if (!empty(setting('whatsapp')))
                                <li class="nav-item">
                                    <a target="_blank" class="nav-link"
                                        href="https://wa.me/{{ setting('whatsapp') }}"><i
                                            class="fab fa-whatsapp"></i></a>
                                </li>
                            @endif
                            @if (!empty(setting('messanger')))
                                <li class="nav-item">
                                    <a target="_blank" class="nav-link" href="{{ setting('messanger') }}"><i
                            ...
                            @if (auth()->check() && auth()->user()->role_id != 1)
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('dashboard') }}"
                                        class="{{ Request::is('dashboard') ? 'active' : '' }}">My Account</a>
                                </li>
                            @endif
                            @auth
                                @if (auth()->user()->role_id == 1 || auth()->user()->role_id == 2)
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ routeHelper('dashboard') }}">Dashboard</a></li>
                                @endif
                            @endauth
                            @guest
    ...
    <div class="top-header header_area" style="background:var(--primary_color);color:var(--primary_bg_color_text)">
        <div class=" containe">
            ...
            <div class="top-menu">
                <ul>
                    <li><a href="{{ route('track') }}" class="{{ Request::is('track*') ? 'active' : '' }}">Order
                            Track</a></li>
                    <li><a href="{{ route('wishlist') }}"
                            class="{{ Request::is('track*') ? 'active' : '' }}">Wishlist</a></li>
                    <li><a href="{{ route('cart') }}" class="{{ Request::is('track*') ? 'active' : '' }}">Cart</a>
                    </li>
