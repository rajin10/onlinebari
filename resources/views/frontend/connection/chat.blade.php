                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        if (xhr.status == 422) {
                            ...
                            responseMessage(response.alert, xhr.responseJSON.message, 'error');
                    ...
                    if (response != '') {
                        ...
                        $.each(response, function (key, val) { 
                            if (val.user_message_log == 'incoming') {
                                ...
                                data += '<div class="msg_cotainer">';
                                data += val.message;
                                data += '<p  class="msg_time msg_time2">'+moment(val.created_at).format('LLL')+'</p>';
                                data += '</div>';
                                data += '</div>';
                            }  
                        });
