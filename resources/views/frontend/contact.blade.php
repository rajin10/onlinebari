                    ...
                    <form action="{{route('contact.store')}}" method="post" id="submit" enctype="multipart/form-data">
                        ...
                        <div class="form form2 row">
                            ...
                            <div class="form-group col-md-6">
                             ...
                             <div class="form-group col-md-6">
                                <input type="numver" name="phone" id="phone" class="form-control" placeholder="Mobile Number">
                            ...
                            <div class="form-group col-md-6">
                              <select name="subject" id="subject"  class="category form-control" required>
                            ...
                            @else
                              <div class="form-group col-md-12">
                                  <input type="text" name="subject" id="subject" class="form-control" placeholder="Enter Your Addresss">
