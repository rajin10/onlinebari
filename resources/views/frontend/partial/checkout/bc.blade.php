...
<div id="checkout">
    <div class="container">
        <form action="{{route('order.buy.store')}}" method="POST">
            @csrf
            <div class="row mt-3">
    ...
    <div id="collapseOne" class="collapse " aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
         @if(setting('g_aamar')=='true')
                                         <label for="aamarpay">
                                            <input type="radio" name="payment_method" class="payment_method" value="aamarpay" id="aamarpay">
                                        ...
                                        @if(setting('g_uddok')=='true')
                                         <label for="uddoktapay">
                                            <input type="radio" name="payment_method" class="payment_method" value="uddoktapay" id="uddoktapay">
    ...
    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
            @if(setting('g_cod')=='true')
                                         <label for="cod">
                                            <input type="radio" name="payment_method" class="payment_method" value="Cash on Delivery" id="cod">
         ...
         @if(setting('g_bkash')=='true')
                                        <label for="Bkash">
                                            <input type="radio" name="payment_method" class="payment_method" value="Bkash" id="Bkash">
                                        ...
                                        <label for="Nagad">
                                            <input type="radio" name="payment_method" class="payment_method" value="Nagad" id="Nagad">
                                        ...
                                        @if(setting('g_rocket')=='true')
                                         <label for="Rocket">
                                            <input type="radio" name="payment_method" class="payment_method" value="Rocket" id="Rocket">
                                        ...
                                        @if(setting('g_bank')=='true')
                                         <label for="Bank">
                                            <input type="radio" name="payment_method" class="payment_method" value="Bank" id="Bank">
                        ...
                        <div class="form-group">
                            <div class="form-group instruction">
                                ...
                                <div class="collapse" id="collapseExample">
                                    ...
                                    <button type="button" class="btn btn-primary btn-block py-2" id="apply-coupon">Apply</button>
                                </div>
                            </div>
                        </div>
                         <input type="hidden" value="0"  id="partial_paid" name="partial_paid" class="form-control" placeholder="Partial Amount"/>
                        <!-- <div class="form-group">-->
                        <!--    <div class="form-group instruction">-->
