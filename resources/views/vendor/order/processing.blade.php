                        ...
                        <tr>
                            ...
                            <td>
                                <div class="inline-flex gap-1">
                                    ...
                                    <x-ui.button variant="primary" size="sm" :href="routeHelper('order/status/delivered/' . $data->id)" title="Delivered" onclick="return confirm('Are you sure delivered this order?')">
