...
namespace App\Core\ShoppingCart;

use Carbon\Carbon;
use Closure;
use App\Core\ShoppingCart\Contracts\Buyable;
use App\Core\ShoppingCart\Contracts\InstanceIdentifier;
use App\Core\ShoppingCart\Exceptions\CartAlreadyStoredException;
use App\Core\ShoppingCart\Exceptions\InvalidRowIDException;
use App\Core\ShoppingCart\Exceptions\UnknownModelException;
...
class Cart
{
     ...
     *
     * @return \App\Core\ShoppingCart\Cart
     */
     ...
     * @param array     $options
     *
     * @return \App\Core\ShoppingCart\CartItem
     */
     ...
     * Add an item to the cart.
     *
     * @param \App\Core\ShoppingCart\CartItem $item          Item to add to the Cart
     * @param bool                              $keepDiscount  Keep the discount rate of the Item
     * @param bool                              $keepTax       Keep the Tax rate of the Item
     * @param bool                              $dispatchEvent
     *
     * @return \App\Core\ShoppingCart\CartItem The CartItem
     */
