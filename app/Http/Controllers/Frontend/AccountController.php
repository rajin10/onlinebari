    ...
    public function pasm(Request $request){
        ...
        //if($request->method=='Phone'){
            ...
            if($user){
                ...
                $ap_key='176506820759340520230505092336pm0I4Ap3Bf'; 
                $sender_id='505';
                $mobile_no = $request->phone;
                // $message = env('APP_NICKNAME') . " Dear Customer, Your New Password: " . $rand;
                $message = " Dear Customer, \n Your Bangoshop account new password: " . $rand;
    
                $user_email='tech.tanvir98@gmail.com';
                ...
                if($resArray['message'] == "Successfull"){
